...
public class FinalTestings {
    ...
    public void finalTest() {
        ...
        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.acno),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText5.perform(replaceText("32948"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText6 = onView(
                allOf(withId(R.id.editText),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText6.perform(replaceText("034"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText9 = onView(
                allOf(withId(R.id.bookacno),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText9.perform(replaceText("32948"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText12 = onView(
                allOf(withId(R.id.booknumber),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText12.perform(replaceText("6585"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatTextView6 = onView(
                allOf(withId(R.id.title), withText("By Emp Id"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText14 = onView(
                allOf(withId(R.id.employeeid),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText14.perform(replaceText("034"), closeSoftKeyboard());

        ViewInteraction appCompatEditText15 = onView(
                allOf(withId(R.id.employeeid), withText("034"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.LinearLayout")),
                                        1),
        ...
        ViewInteraction appCompatButton9 = onView(
                allOf(withId(R.id.resetAll), withText("Reset Status"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText17 = onView(
                allOf(withId(R.id.userName),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText17.perform(replaceText("123@gmail.com"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText18 = onView(
                allOf(withId(R.id.password),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText18.perform(replaceText("12345678"), closeSoftKeyboard());
