    ...
    public void submit1(View view) {
        ...
        mReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (string.isEmpty()) {
                    Toast.makeText(CheckIssuedEmployee.this, "Please Enter Emp ID To Search", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    booksName.setAdapter(new ArrayAdapter<String>(CheckIssuedEmployee.this, android.R.layout.simple_list_item_1, bookNames));
                }
            }
